...
:
    ...
    YFuelFuelStream_(dimensionedScalar::lookupOrDefault("YFuelFuelStream", this->coeffs(), dimless, 1.0)),
    YO2OxiStream_(dimensionedScalar::lookupOrDefault("YO2OxiStream", this->coeffs(), dimless, 0.23)),
