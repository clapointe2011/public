...
#include "eddyDissipationDiffusion.H"
...
eddyDissipationDiffusion<ReactionThermo, ThermoType>::eddyDissipationDiffusion
(
...
eddyDissipationDiffusion<ReactionThermo, ThermoType>::rtTurb() const
{
...
template<class ReactionThermo, class ThermoType>
Foam::tmp<Foam::volScalarField>
eddyDissipationDiffusion<ReactionThermo, ThermoType>::rtDiff() const
{
...
template<class ReactionThermo, class ThermoType>
void eddyDissipationDiffusion<ReactionThermo, ThermoType>::correct()
{
    this->wFuel_ ==
...
template<class ReactionThermo, class ThermoType>
bool eddyDissipationDiffusion<ReactionThermo, ThermoType>::read()
{
