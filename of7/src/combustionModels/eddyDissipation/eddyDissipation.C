...
eddyDissipation<ReactionThermo, ThermoType>::eddyDissipation
(
...
eddyDissipation<ReactionThermo, ThermoType>::rtTurb() const
{
...
template<class ReactionThermo, class ThermoType>
Foam::tmp<Foam::volScalarField>
eddyDissipation<ReactionThermo, ThermoType>::rtDiff() const
{
...
template<class ReactionThermo, class ThermoType>
void eddyDissipation<ReactionThermo, ThermoType>::correct()
{
    this->wFuel_ ==
...
template<class ReactionThermo, class ThermoType>
bool eddyDissipation<ReactionThermo, ThermoType>::read()
{
