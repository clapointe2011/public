...
#include "dynamicRefineBalanceFvMesh.H"
...
namespace Foam
{
    defineTypeNameAndDebug(dynamicRefineBalanceFvMesh, 0);
    addToRunTimeSelectionTable(dynamicFvMesh, dynamicRefineBalanceFvMesh, IOobject);
}


// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

Foam::label Foam::dynamicRefineBalanceFvMesh::count
(
...
void Foam::dynamicRefineBalanceFvMesh::calculateProtectedCells
(
...
void Foam::dynamicRefineBalanceFvMesh::readDict()
{
...
Foam::dynamicRefineBalanceFvMesh::refine
(
...
Foam::autoPtr<Foam::mapPolyMesh>
Foam::dynamicRefineBalanceFvMesh::unrefine
(
...
Foam::scalarField
Foam::dynamicRefineBalanceFvMesh::maxPointField(const scalarField& pFld) const
{
...
Foam::scalarField
Foam::dynamicRefineBalanceFvMesh::maxCellField(const volScalarField& vFld) const
{
...
Foam::scalarField
Foam::dynamicRefineBalanceFvMesh::cellToPoint(const scalarField& vFld) const
{
...
Foam::scalarField Foam::dynamicRefineBalanceFvMesh::error
(
...
void Foam::dynamicRefineBalanceFvMesh::selectRefineCandidates
(
...
Foam::labelList Foam::dynamicRefineBalanceFvMesh::selectRefineCells
(
...
Foam::labelList Foam::dynamicRefineBalanceFvMesh::selectUnrefinePoints
(
...
void Foam::dynamicRefineBalanceFvMesh::extendMarkedCells
(
...
void Foam::dynamicRefineBalanceFvMesh::checkEightAnchorPoints
(
...
Foam::dynamicRefineBalanceFvMesh::dynamicRefineBalanceFvMesh(const IOobject& io)
:
    dynamicFvMesh(io),
...
Foam::dynamicRefineBalanceFvMesh::~dynamicRefineBalanceFvMesh()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

bool Foam::dynamicRefineBalanceFvMesh::update()
{
    ...
    if (time().timeIndex() > 0 && time().timeIndex() % refineInterval == 0)
    {
        ...
        label nBufferLayers = readLabel(refineDict.lookup("nBufferLayers"));
...
bool Foam::dynamicRefineBalanceFvMesh::redistribute()
{
    if (!Pstream::parRun())
    {
        return 0;
    ...
    if (Pstream::master())
    {
        ...
        Foam::system("reconstructParMesh >> log.balance");
        Foam::system("reconstructPar >> log.balance");
        Foam::system("rm -r processor*");
        Foam::system("decomposePar -latestTime -force >> log.balance");
...
bool Foam::dynamicRefineBalanceFvMesh::balance()
{
    if (!Pstream::parRun())
    {
        return false;
...
bool Foam::dynamicRefineBalanceFvMesh::writeObject
(
