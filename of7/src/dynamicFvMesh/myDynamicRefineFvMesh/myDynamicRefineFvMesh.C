...
//CL from https://github.com/ElsevierSoftwareX/SOFTX_2018_143
Foam::label Foam::myDynamicRefineFvMesh::topParentID(const label p) const
{
...
Foam::label Foam::myDynamicRefineFvMesh::count
(
...
)
{
    ...
    */
    ...
    // CL done explicitly in diffusionFireFoam; not needed here ?
    /*{
...
(
    const labelList& splitElems //CL use splitELems instead of splitPoints
)
{
    polyTopoChange meshMod(*this);
    ...
    */
    ...
    // CL done explicitly for diffusionFireFoam; not needed here ?
    /*{
...
Foam::myDynamicRefineFvMesh::myDynamicRefineFvMesh(const IOobject& io)
:
    dynamicFvMesh(io),
    meshCutter_(hexRef::New(*this)), //CL from blastFoam
    dumpLevel_(false),
    nRefinementIterations_(0),
    protectedCell_(nCells(), 0)
{
    //CL protexted cell initialization from
