...
#include "dynamicRefineMotionSolverFvMesh.H"
...
#include "wedgePolyPatch.H" //CL for updates from https://github.com/ElsevierSoftwareX/SOFTX_2018_143
#include "emptyPolyPatch.H" //CL for updates from https://github.com/ElsevierSoftwareX/SOFTX_2018_143

// * * * * * * * * * * * * * * Static Data Members * * * * * * * * * * * * * //

namespace Foam
{
    defineTypeNameAndDebug(dynamicRefineMotionSolverFvMesh, 0);
    addToRunTimeSelectionTable(dynamicFvMesh, dynamicRefineMotionSolverFvMesh, IOobject);

    //CL from https://github.com/ElsevierSoftwareX/SOFTX_2018_143
...
Foam::label Foam::dynamicRefineMotionSolverFvMesh::count
(
...
void Foam::dynamicRefineMotionSolverFvMesh::calculateProtectedCells
(
...
void Foam::dynamicRefineMotionSolverFvMesh::readDict()
{
...
Foam::dynamicRefineMotionSolverFvMesh::refine
(
...
Foam::autoPtr<Foam::mapPolyMesh>
Foam::dynamicRefineMotionSolverFvMesh::unrefine
(
...
Foam::scalarField
Foam::dynamicRefineMotionSolverFvMesh::maxPointField(const scalarField& pFld) const
{
...
Foam::scalarField
Foam::dynamicRefineMotionSolverFvMesh::maxCellField(const volScalarField& vFld) const
{
...
Foam::scalarField
Foam::dynamicRefineMotionSolverFvMesh::cellToPoint(const scalarField& vFld) const
{
...
Foam::scalarField Foam::dynamicRefineMotionSolverFvMesh::error
(
...
void Foam::dynamicRefineMotionSolverFvMesh::selectRefineCandidates
(
...
Foam::labelList Foam::dynamicRefineMotionSolverFvMesh::selectRefineCells
(
...
Foam::labelList Foam::dynamicRefineMotionSolverFvMesh::selectUnrefinePoints
(
...
void Foam::dynamicRefineMotionSolverFvMesh::extendMarkedCells
(
...
void Foam::dynamicRefineMotionSolverFvMesh::checkEightAnchorPoints
(
...
Foam::dynamicRefineMotionSolverFvMesh::dynamicRefineMotionSolverFvMesh(const IOobject& io)
:
    dynamicFvMesh(io),
...
Foam::dynamicRefineMotionSolverFvMesh::~dynamicRefineMotionSolverFvMesh()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

const Foam::motionSolver& Foam::dynamicRefineMotionSolverFvMesh::motion() const
{
    return motionPtr_();
}

bool Foam::dynamicRefineMotionSolverFvMesh::update()
{
    //CL update motion
...
bool Foam::dynamicRefineMotionSolverFvMesh::redistribute()
{
    return false;
}

bool Foam::dynamicRefineMotionSolverFvMesh::balance()
{
    return false;
}


bool Foam::dynamicRefineMotionSolverFvMesh::writeObject
(
