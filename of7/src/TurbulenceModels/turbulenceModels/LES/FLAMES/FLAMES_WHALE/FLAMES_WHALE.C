...
void FLAMES_WHALE<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> FLAMES_WHALE<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
FLAMES_WHALE<BasicTurbulenceModel>::FLAMES_WHALE
(
...
template<class BasicTurbulenceModel>
bool FLAMES_WHALE<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> FLAMES_WHALE<BasicTurbulenceModel>::epsilon() const
{
...
template<class BasicTurbulenceModel>
void FLAMES_WHALE<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
