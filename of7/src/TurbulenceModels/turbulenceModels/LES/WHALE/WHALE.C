...
void WHALE<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> WHALE<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
WHALE<BasicTurbulenceModel>::WHALE
(
...
template<class BasicTurbulenceModel>
bool WHALE<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> WHALE<BasicTurbulenceModel>::epsilon() const
{
...
template<class BasicTurbulenceModel>
void WHALE<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
