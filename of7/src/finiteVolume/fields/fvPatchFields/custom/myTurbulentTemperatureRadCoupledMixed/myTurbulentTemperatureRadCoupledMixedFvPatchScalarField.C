...
#include "myTurbulentTemperatureRadCoupledMixedFvPatchScalarField.H"
...
myTurbulentTemperatureRadCoupledMixedFvPatchScalarField::
myTurbulentTemperatureRadCoupledMixedFvPatchScalarField
(
    const fvPatch& p,
...
myTurbulentTemperatureRadCoupledMixedFvPatchScalarField
(
    const myTurbulentTemperatureRadCoupledMixedFvPatchScalarField& psf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void myTurbulentTemperatureRadCoupledMixedFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    typedef myTurbulentTemperatureRadCoupledMixedFvPatchScalarField thisType;
...
void myTurbulentTemperatureRadCoupledMixedFvPatchScalarField::write
(
    Ostream& os
) const
{
    ...
    writeEntry(os, "thermalInertia", thermalInertia_);
