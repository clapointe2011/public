...
{
    defineTypeNameAndDebug(constRadFraction, 0);
...
Foam::radiationModels::absorptionEmissionModels::constRadFraction::constRadFraction
(
...
Foam::radiationModels::absorptionEmissionModels::constRadFraction::aCont(const label bandI) const
{
...
Foam::tmp<Foam::volScalarField>
Foam::radiationModels::absorptionEmissionModels::constRadFraction::eCont(const label bandI) const
{
