...
#include "dynamicRefineMotionSolverFvMesh2D.H"
...
namespace Foam
{
    defineTypeNameAndDebug(dynamicRefineMotionSolverFvMesh2D, 0);
    addToRunTimeSelectionTable(dynamicFvMesh, dynamicRefineMotionSolverFvMesh2D, IOobject);
}
...
Foam::label Foam::dynamicRefineMotionSolverFvMesh2D::count
(
...
void Foam::dynamicRefineMotionSolverFvMesh2D::calculateProtectedCells
(
...
void Foam::dynamicRefineMotionSolverFvMesh2D::readDict()
{
...
Foam::dynamicRefineMotionSolverFvMesh2D::refine
(
...
// (an approximate) flux
Foam::autoPtr<Foam::mapPolyMesh>
Foam::dynamicRefineMotionSolverFvMesh2D::unrefine
(
...
Foam::scalarField
Foam::dynamicRefineMotionSolverFvMesh2D::maxPointField(const scalarField& pFld) const
{
...
Foam::scalarField
Foam::dynamicRefineMotionSolverFvMesh2D::maxCellField(const volScalarField& vFld) const
{
...
Foam::scalarField
Foam::dynamicRefineMotionSolverFvMesh2D::cellToPoint(const scalarField& vFld) const
{
...
Foam::scalarField Foam::dynamicRefineMotionSolverFvMesh2D::error
(
...
void Foam::dynamicRefineMotionSolverFvMesh2D::selectRefineCandidates
(
...
Foam::labelList Foam::dynamicRefineMotionSolverFvMesh2D::selectRefineCells
(
...
Foam::labelList Foam::dynamicRefineMotionSolverFvMesh2D::selectUnrefineEdges
(
...
void Foam::dynamicRefineMotionSolverFvMesh2D::extendMarkedCells
(
...
void Foam::dynamicRefineMotionSolverFvMesh2D::checkEightAnchorPoints
(
...
Foam::dynamicRefineMotionSolverFvMesh2D::dynamicRefineMotionSolverFvMesh2D(const IOobject& io)
:
    dynamicFvMesh(io),
    meshCutter_(*this),
    dumpLevel_(false),
...
Foam::dynamicRefineMotionSolverFvMesh2D::~dynamicRefineMotionSolverFvMesh2D()
{}


// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //

const Foam::motionSolver& Foam::dynamicRefineMotionSolverFvMesh2D::motion() const
{
    return motionPtr_();
}

bool Foam::dynamicRefineMotionSolverFvMesh2D::update()
{
    //CL update motion
...
bool Foam::dynamicRefineMotionSolverFvMesh2D::writeObject
(
